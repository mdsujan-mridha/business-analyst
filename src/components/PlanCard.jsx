            ...
            <div className="box-border px-4 mx-auto border-solid sm:px-6 md:px-6 lg:px-0 max-w-7xl">
                <div className="flex flex-col items-center leading-7 text-center text-gray-900 border-0 border-gray-200">
                    ...
                    <p className="box-border mt-2 text-xl text-gray-900 border-solid sm:text-2xl">
                        Unlock advanced features for 2 months! <br />Try them out and decide if they're right for you.
                    </p>
                </div>
                <div id="pricing"
                    className="grid grid-cols-1 gap-4 mt-4 leading-7 text-gray-900 border-0 border-gray-200 sm:mt-6 sm:gap-6 md:mt-8 md:gap-0 lg:grid-cols-3 lg:gap-10">
                    {/* <!-- Price 1 --> */}
                    <div
                        className="relative z-10 flex flex-col items-center w-96 p-4 mx-auto my-0 border border-solid rounded-lg lg:-mr-3 sm:my-0 sm:p-6 md:my-8 md:p-8">
                        <h3
                        ...
                        <p className=' font-semibold py-3'> For individuals and small teams </p>
                        <a href="#"
                    ...
                    {/* <!-- Price 2 --> */}
                    <div
                        className="relative z-20 flex flex-col items-center w-96 p-4 mx-auto my-0 bg-white border-4 border-blue-600 border-solid rounded-lg sm:p-6 md:px-8 md:py-16">
                        <h3
                            className="m-0 text-2xl font-semibold leading-tight tracking-tight text-black border-0 border-gray-200 sm:text-3xl md:text-4xl">
                            Pro
                        </h3>
                        ...
                        <p className=' font-semibold py-3'> For startups and growing business  </p>
                        <a href="#"
                    ...
                    {/* <!-- Price 3 --> */}
                    <div
                        className="relative z-10 flex flex-col items-center w-96 p-4 mx-auto my-0 border border-solid rounded-lg lg:-ml-3 sm:my-0 sm:p-6 md:my-8 md:p-8">
                        <h3
                            className="m-0 text-2xl font-semibold leading-tight tracking-tight text-black border-0 border-gray-200 sm:text-3xl md:text-4xl">
                            Business
                        </h3>
                        ...
                        <p className=' font-semibold py-3'> For organizations with advanced needs </p>
                        {/* <ul>
                            {
                                proData.map((data, index) => (
                                    <>
                                        <p className='flex justify-start items-center text-md text-black font-semibold' key={index}> <MdCheckBox /> <span> {data} </span> </p>
                                    </>
                                ))
                            }
